...
var validator = (function($){
    ...
    */
    message = {
        invalid         : 'Campo no valido',
        checked         : 'must be checked',
        empty           : 'Complete el campo',
        min             : 'Campo demaciado corto',
        max             : 'Campo demaciado largo',
        number_min      : 'too low',
        number_max      : 'too high',
        url             : 'invalid URL',
        number          : 'Este no es un numero',
        email           : 'Correo no valido',
        email_repeat    : 'Email no coincide',
        password_repeat : 'La Contraseña no coincide',
        repeat          : 'no match',
        complete        : 'Complete el campo',
        select          : 'Por favor Selecciona una'
    };
